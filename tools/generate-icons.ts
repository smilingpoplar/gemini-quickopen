...
async function generateAllIcons(): Promise<void> {
  ...
  for (const size of sizes) {
    await convertSvgToPng(size, path.join(iconsDir, `icon${size}.png`));
  }
  console.log('All Gemini icons generated successfully!');
}
